...
data3$Date_informat <- strptime(paste(data3$Date,data3$Time),
                                format = "%d/%m/%Y %H:%M:%S")
...
plot(data3$Date_informat,data3$Sub_metering_1,type = "l",xaxt = "n",xlab = "",ylab = "")
lines(data3$Date_informat,data3$Sub_metering_2,col = "red")
lines(data3$Date_informat,data3$Sub_metering_3,col = "blue")
